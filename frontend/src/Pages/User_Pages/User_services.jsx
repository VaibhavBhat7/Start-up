...
const User_services = () => {
    ...
    <div id="get-involved">
        ...
        <p>Explore the city with Walkez. Whether you need a scenic route, a quick path, or an accessible street, our services have you covered. Download the Walkez app today and start exploring.</p>
    </div>
